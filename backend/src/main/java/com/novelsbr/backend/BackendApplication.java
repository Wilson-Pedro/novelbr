...
//		Set<Gender> genders1 = new HashSet<>();
//		genders1.add(genders.get(0));
//		genders1.add(genders.get(4));
//		genders1.add(genders.get(7));
//		genders1.add(genders.get(13));
//		
//		Set<Gender> genders2 = new HashSet<>();
//		genders1.add(genders.get(8));
//		genders1.add(genders.get(16));
//		genders1.add(genders.get(19));
//		
//		Set<Gender> genders3 = new HashSet<>();
//		genders1.add(genders.get(0));
//		genders1.add(genders.get(2));
//		genders1.add(genders.get(7));
//		genders1.add(genders.get(13));
//		
//		Set<Gender> genders4 = new HashSet<>();
//		genders1.add(genders.get(0));
//		genders1.add(genders.get(2));
//		genders1.add(genders.get(3));
//		genders1.add(genders.get(6));
//		genders1.add(genders.get(7));
//		genders1.add(genders.get(14));
//		genders1.add(genders.get(6));
//		genders1.add(genders.get(15));
