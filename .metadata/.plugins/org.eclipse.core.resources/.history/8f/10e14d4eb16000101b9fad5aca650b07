...
public class BackendApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		NovelDTO novelDTO1 = new NovelDTO(null, "A casa ao Lado", author1.getId(), "em curso", gendersStr, 
		...
		NovelDTO novelDTO2 = new NovelDTO(null, "Isto é vida", author2.getId(), "em curso", gendersStr, 
		...
		NovelDTO novelDTO3 = new NovelDTO(null, "Trem para o nunca", author3.getId(), "em curso", gendersStr, 
		...
		NovelDTO novelDTO4 = new NovelDTO(null, "Jornada para o Além", author4.getId(), "em curso", gendersStr, 
